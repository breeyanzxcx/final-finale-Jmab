document.addEventListener("DOMContentLoaded", () => {
    ...
    if (sortLowHighBtn) {
        sortLowHighBtn.addEventListener("click", (e) => {
            ...
            sortLowHighBtn.classList.add("active"); // Add active to Low to High
            sortHighLowBtn.classList.remove("active"); // Remove active from High to Low
        });
    }
    ...
    if (sortHighLowBtn) {
        sortHighLowBtn.addEventListener("click", (e) => {
            ...
            sortHighLowBtn.classList.add("active"); // Add active to High to Low
            sortLowHighBtn.classList.remove("active"); // Remove active from Low to High
        });
    }
